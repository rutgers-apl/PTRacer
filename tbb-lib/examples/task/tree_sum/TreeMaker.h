...
class TreeMaker {
    ...
    public:
	  ...
	  //tbb::task* next = NULL;
		...
		//std::cout << " b Task Id = " << b->getTaskId() << std::endl;
		//next = a;
		//set_ref_count(2);
		tbb::t_debug_task::spawn_and_wait_for_all(*a);
		//std::cout << "a Task Id = " << a->getTaskId() << std::endl;
	      }
...
public:
	...
	//std::cout << "tid = " << a.getTaskId() << std::endl;
        return root_node;
    }
